...
from motion_test_pkg.srv import BoxAttach, BoxAttachResponse, BoxSpawnerResponse, BoxSpawner

moveit_commander.roscpp_initialize(sys.argv)
rospy.init_node('scene_node', anonymous=True, log_level=rospy.WARN)
scene = moveit_commander.PlanningSceneInterface()

#MODIFY DEPENDING ON THE NAME OF THE LINKS OF YOUR ROBOT
eef_links = ["one_wsg_base_link", "two_wsg_base_link"]
touch_links = [["one_wsg_finger_left, one_wsg_finger_right"],
               ["two_wsg_finger_left, two_wsg_finger_right"]]
