#! /usr/bin/env python3
"""
This the code for motion control node responsible for executing the process where two boxes, base box and
...
class MotionController:
    ...
    def loginfo(self, text):
        """
        Logger funtion with desired formatting to make the readability of the log messages in the terminal better.
